...
- Test coverage parity per `AGENTS.md`: each new real surface gets an integration test against real Postgres + real AI (free `opencode/gpt-5-nano`), not just unit tests
