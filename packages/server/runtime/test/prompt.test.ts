...
describe("renderPromptBody", () => {
  ...
  it("orders mandate → artifacts → context → scheduling → goal autodetect → persistence → goal → Desk skill router → user instructions", () => {
    ...
    expect(idxGoal).toBeGreaterThan(idxPersistence);
