...
import {
  ...
  isStructuredToolPayloadLine,
  isUserVisibleDiagnosticLine,
  structuredToolPayloadSql,
...
// SQL-fragment + diagnostic-line helpers extracted into
// messages.sql-helpers.ts. The hoisted-export-style imports at the
// top of this file bring them back in. Keep the extraction tight so
