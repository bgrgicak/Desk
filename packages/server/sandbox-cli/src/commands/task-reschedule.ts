...
export const usage =
  "roomy-agent task reschedule --chat <id> --message-id <msg> (--at <iso8601> | --cron <expr>) [--title <text>] [<content>]";

export const help = `\
roomy-agent task reschedule — change an existing task's schedule in place.
...
Use roomy-agent task schedule for a *new* task card, and roomy-agent task
