...
// from `ChatMenuItems`) and the right-panel toggle. Portals into the
// top bar via `TopBarActions`. Search/filter icons live on the TasksPage
// top bar — the chat right panel just shows files + tasks for this chat
// without filtering.
